 ...
 * provided */
int
MOS3load(MOS3Model *inModel, Shim::Ckt *ckt)
{
auto &mat = *ckt->mat;
...
innerline1000:;
		...
		if ( (here->MOS3off == 0)  || 
		    ...
		    if (Check == 1) {
			ckt->CKTnoncon++;
			ckt->CKTtroubleElt = (MOS3Instance *) here;
		    }
		}
...
#endif		 	    	    
		mat.add(here->MOS3DdPtr, (here->MOS3drainConductance));
		mat.add(here->MOS3GgPtr, ((gcgd+gcgs+gcgb)));
		mat.add(here->MOS3SsPtr, (here->MOS3sourceConductance));
		mat.add(here->MOS3BbPtr, (here->MOS3gbd+here->MOS3gbs+gcgb));
		mat.add(here->MOS3DPdpPtr, (here->MOS3drainConductance+here->MOS3gds+
		     here->MOS3gbd+xrev*(here->MOS3gm+here->MOS3gmbs)+gcgd));
		mat.add(here->MOS3SPspPtr, (here->MOS3sourceConductance+here->MOS3gds+
		     here->MOS3gbs+xnrm*(here->MOS3gm+here->MOS3gmbs)+gcgs));
		mat.add(here->MOS3DdpPtr, (-here->MOS3drainConductance));
		mat.add(here->MOS3GbPtr, -(gcgb));
		mat.add(here->MOS3GdpPtr, -(gcgd));
		mat.add(here->MOS3GspPtr, -(gcgs));
		mat.add(here->MOS3SspPtr, (-here->MOS3sourceConductance));
		mat.add(here->MOS3BgPtr, -(gcgb));
		mat.add(here->MOS3BdpPtr, -(here->MOS3gbd));
		mat.add(here->MOS3BspPtr, -(here->MOS3gbs));
		mat.add(here->MOS3DPdPtr, (-here->MOS3drainConductance));
		mat.add(here->MOS3DPgPtr, ((xnrm-xrev)*here->MOS3gm-gcgd));
		mat.add(here->MOS3DPbPtr, (-here->MOS3gbd+(xnrm-xrev)*here->MOS3gmbs));
		mat.add(here->MOS3DPspPtr, (-here->MOS3gds-
					 xnrm*(here->MOS3gm+here->MOS3gmbs)));
		mat.add(here->MOS3SPgPtr, (-(xnrm-xrev)*here->MOS3gm-gcgs));
		mat.add(here->MOS3SPsPtr, (-here->MOS3sourceConductance));
