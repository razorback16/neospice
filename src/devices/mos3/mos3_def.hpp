...
struct MOS3Instance {
    MOS3Model *MOS3modPtr;  /* backpointer to model */
    MOS3Instance *MOS3nextInstance;  /* pointer to next instance of 
                                              *current model*/
    const char *MOS3name; /* pointer to character string naming this instance */
    ...
    neospice::MatrixOffset MOS3DdPtr{-1};      /* pointer to sparse matrix element at
                                     * (Drain node,drain node) */
    neospice::MatrixOffset MOS3GgPtr{-1};      /* pointer to sparse matrix element at
                                     * (gate node,gate node) */
    neospice::MatrixOffset MOS3SsPtr{-1};      /* pointer to sparse matrix element at
                                     * (source node,source node) */
    neospice::MatrixOffset MOS3BbPtr{-1};      /* pointer to sparse matrix element at
                                     * (bulk node,bulk node) */
    neospice::MatrixOffset MOS3DPdpPtr{-1};    /* pointer to sparse matrix element at
                                     * (drain prime node,drain prime node) */
    neospice::MatrixOffset MOS3SPspPtr{-1};    /* pointer to sparse matrix element at
                                     * (source prime node,source prime node) */
    neospice::MatrixOffset MOS3DdpPtr{-1};     /* pointer to sparse matrix element at
                                     * (drain node,drain prime node) */
    neospice::MatrixOffset MOS3GbPtr{-1};      /* pointer to sparse matrix element at
                                     * (gate node,bulk node) */
    neospice::MatrixOffset MOS3GdpPtr{-1};     /* pointer to sparse matrix element at
                                     * (gate node,drain prime node) */
    neospice::MatrixOffset MOS3GspPtr{-1};     /* pointer to sparse matrix element at
                                     * (gate node,source prime node) */
    neospice::MatrixOffset MOS3SspPtr{-1};     /* pointer to sparse matrix element at
                                     * (source node,source prime node) */
    neospice::MatrixOffset MOS3BdpPtr{-1};     /* pointer to sparse matrix element at
                                     * (bulk node,drain prime node) */
    neospice::MatrixOffset MOS3BspPtr{-1};     /* pointer to sparse matrix element at
                                     * (bulk node,source prime node) */
    neospice::MatrixOffset MOS3DPspPtr{-1};    /* pointer to sparse matrix element at
                                     * (drain prime node,source prime node) */
    neospice::MatrixOffset MOS3DPdPtr{-1};     /* pointer to sparse matrix element at
                                     * (drain prime node,drain node) */
    neospice::MatrixOffset MOS3BgPtr{-1};      /* pointer to sparse matrix element at
                                     * (bulk node,gate node) */
    neospice::MatrixOffset MOS3DPgPtr{-1};     /* pointer to sparse matrix element at
                                     * (drain prime node,gate node) */

    neospice::MatrixOffset MOS3SPgPtr{-1};     /* pointer to sparse matrix element at
                                     * (source prime node,gate node) */
    neospice::MatrixOffset MOS3SPsPtr{-1};     /* pointer to sparse matrix element at
                                     * (source prime node,source node) */
    neospice::MatrixOffset MOS3DPbPtr{-1};     /* pointer to sparse matrix element at
                                     * (drain prime node,bulk node) */
    neospice::MatrixOffset MOS3SPbPtr{-1};     /* pointer to sparse matrix element at
                                     * (source prime node,bulk node) */
    neospice::MatrixOffset MOS3SPdpPtr{-1};    /* pointer to sparse matrix element at
...
struct MOS3Model {       /* model structure for a resistor */
    int MOS3modType;    /* type index of this device type */
    MOS3Model *MOS3nextModel;    /* pointer to next possible model 
                                          *in linked list */
    MOS3Instance * MOS3instances; /* pointer to list of instances 
                                   * that have this model */
    const char *MOS3modName;       /* pointer to character string naming this model */

    /* --- end of generic struct MOS3Model --- */
...
extern Shim::IfParm MOS3pTable[];
extern int MOS3pTSize;
extern Shim::IfParm MOS3mPTable[];
extern int MOS3mPTSize;
int MOS3mParam(int param, Shim::IfValue *value, MOS3Model *model);
int MOS3param(int param, Shim::IfValue *value, MOS3Instance *inst, Shim::IfValue *select);
