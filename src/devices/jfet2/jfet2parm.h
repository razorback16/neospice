// jfet2parm.h — Parker-Skellern JFET2 model parameter definitions.
// This file is included multiple times with different PARAM/PARAMA macros
// to expand into model struct fields, Given flags, or parameter dispatch.
//
// Each entry: PARAM("keyword", id, givenFlag, field, default, "description")
// PARAMA is the same but indicates the parameter should have IOPA semantics.
