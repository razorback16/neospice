...
struct HSM2Instance {
  HSM2Model *HSM2modPtr;           /* pointer to model */
  HSM2Instance *HSM2nextInstance;  /* pointer to next instance of 
                                              current model*/
  const char *HSM2name; /* pointer to character string naming this instance */
...
/*   unsigned HSM2_rshg_Given  :1; */
 ...
 /* WPE */
  ...
  neospice::MatrixOffset HSM2GgPtr{-1};   /* pointer to sparse matrix element at (gate node,gate node) */
  neospice::MatrixOffset HSM2GgpPtr{-1};  /* pointer to sparse matrix element at (gate node,gate prime node) */
  neospice::MatrixOffset HSM2GdpPtr{-1};  /* pointer to sparse matrix element at (gate node,drain prime node) */
  neospice::MatrixOffset HSM2GspPtr{-1};  /* pointer to sparse matrix element at (gate node,source prime node) */
  neospice::MatrixOffset HSM2GbpPtr{-1};  /* pointer to sparse matrix element at (gate node,bulk prime node) */

  neospice::MatrixOffset HSM2GPgPtr{-1};  /* pointer to sparse matrix element at (gate prime node,gate node) */
  neospice::MatrixOffset HSM2GPgpPtr{-1};  /* pointer to sparse matrix element at (gate prime node,gate prime node) */
  neospice::MatrixOffset HSM2GPdpPtr{-1};  /* pointer to sparse matrix element at (gate prime node,drain prime node) */
  neospice::MatrixOffset HSM2GPspPtr{-1};  /* pointer to sparse matrix element at (gate prime node,source prime node) */
  neospice::MatrixOffset HSM2GPbpPtr{-1};  /* pointer to sparse matrix element at (gate prime node,bulk prime node) */

  neospice::MatrixOffset HSM2DPdPtr{-1};  /* pointer to sparse matrix element at (drain prime node,drain node) */
  neospice::MatrixOffset HSM2DPdpPtr{-1}; /* pointer to sparse matrix element at (drain prime node,drain prime node) */
  neospice::MatrixOffset HSM2DPgpPtr{-1}; /* pointer to sparse matrix element at (drain prime node,gate prime node) */
  neospice::MatrixOffset HSM2DPspPtr{-1}; /* pointer to sparse matrix element at (drain prime node,source prime node) */
  neospice::MatrixOffset HSM2DPbpPtr{-1}; /* pointer to sparse matrix element at (drain prime node,bulk prime node) */
  neospice::MatrixOffset HSM2DPdbPtr{-1}; /* pointer to sparse matrix element at (drain prime node,drain body node) */

  neospice::MatrixOffset HSM2DdPtr{-1};   /* pointer to sparse matrix element at (Drain node,drain node) */
  neospice::MatrixOffset HSM2DdpPtr{-1};  /* pointer to sparse matrix element at (drain node,drain prime node) */

  neospice::MatrixOffset HSM2SPsPtr{-1};  /* pointer to sparse matrix element at (source prime node,source node) */
  neospice::MatrixOffset HSM2SPspPtr{-1}; /* pointer to sparse matrix element at (source prime node,source prime node) */
  neospice::MatrixOffset HSM2SPgpPtr{-1}; /* pointer to sparse matrix element at (source prime node,gate prime node) */
  neospice::MatrixOffset HSM2SPdpPtr{-1}; /* pointer to sparse matrix element at (source prime node,drain prime node) */
  neospice::MatrixOffset HSM2SPbpPtr{-1}; /* pointer to sparse matrix element at (source prime node,bulk prime node) */
  neospice::MatrixOffset HSM2SPsbPtr{-1}; /* pointer to sparse matrix element at (source prime node,source body node) */

  neospice::MatrixOffset HSM2SsPtr{-1};   /* pointer to sparse matrix element at (source node,source node) */
  neospice::MatrixOffset HSM2SspPtr{-1};  /* pointer to sparse matrix element at (source node,source prime node) */

  neospice::MatrixOffset HSM2BPgpPtr{-1};  /* pointer to sparse matrix element at (bulk prime node,gate prime node) */
  neospice::MatrixOffset HSM2BPbpPtr{-1}; /* pointer to sparse matrix element at (bulk prime node,bulk prime node) */
  neospice::MatrixOffset HSM2BPdpPtr{-1}; /* pointer to sparse matrix element at (bulk prime node,drain prime node) */
  neospice::MatrixOffset HSM2BPspPtr{-1}; /* pointer to sparse matrix element at (bulk prime node,source prime node) */
  neospice::MatrixOffset HSM2BPbPtr{-1};  /* pointer to sparse matrix element at (bulk prime node,bulk node) */
  neospice::MatrixOffset HSM2BPdbPtr{-1}; /* pointer to sparse matrix element at (bulk prime node,source body node) */
  neospice::MatrixOffset HSM2BPsbPtr{-1}; /* pointer to sparse matrix element at (bulk prime node,source body node) */

  neospice::MatrixOffset HSM2DBdpPtr{-1}; /* pointer to sparse matrix element at (drain body node,drain prime node) */
  neospice::MatrixOffset HSM2DBdbPtr{-1}; /* pointer to sparse matrix element at (drain body node,drain body node) */
  neospice::MatrixOffset HSM2DBbpPtr{-1}; /* pointer to sparse matrix element at (drain body node,bulk prime node) */
  neospice::MatrixOffset HSM2DBbPtr{-1};  /* pointer to sparse matrix element at (drain body node,bulk node) */
  
  neospice::MatrixOffset HSM2SBspPtr{-1}; /* pointer to sparse matrix element at (source body node,drain prime node) */
  neospice::MatrixOffset HSM2SBbpPtr{-1}; /* pointer to sparse matrix element at (source body node,drain body node) */
  neospice::MatrixOffset HSM2SBbPtr{-1};  /* pointer to sparse matrix element at (source body node,bulk prime node) */
  neospice::MatrixOffset HSM2SBsbPtr{-1}; /* pointer to sparse matrix element at (source body node,bulk node) */

  neospice::MatrixOffset HSM2BsbPtr{-1};  /* pointer to sparse matrix element at (bulk node,source body node) */
  neospice::MatrixOffset HSM2BbpPtr{-1};  /* pointer to sparse matrix element at (bulk node,bulk prime node) */
  neospice::MatrixOffset HSM2BdbPtr{-1};  /* pointer to sparse matrix element at (bulk node,drain body node) */
  neospice::MatrixOffset HSM2BbPtr{-1};   /* pointer to sparse matrix element at (bulk node,bulk node) */
...
struct HSM2Model {       	/* model structure for a resistor */
  int HSM2modType;    		/* type index of this device type */
  HSM2Model *HSM2nextModel; /* pointer to next possible model 
					 in linked list */
  HSM2Instance * HSM2instances;	/* pointer to list of instances 
				   that have this model */
  const char *HSM2modName;       	/* pointer to the name of this model */

  /* --- end of generic struct HSM2Model --- */
...
#ifdef USE_OMP
    int HSM2InstCount;
    HSM2Instance **HSM2InstanceArray;
#endif
...
extern Shim::IfParm HSM2pTable[];
extern int HSM2pTSize;
extern Shim::IfParm HSM2mPTable[];
extern int HSM2mPTSize;
int HSM2mParam(int param, Shim::IfValue *value, HSM2Model *model);
int HSM2param(int param, Shim::IfValue *value, HSM2Instance *inst, Shim::IfValue *select);
