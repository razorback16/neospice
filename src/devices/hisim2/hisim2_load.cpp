...
/*	delvged = vged - vgedo;*/
 ...
 line900:
    ...
    *(ckt->CKTrhs + here->HSM2gNodePrime) -= ceqqg + Igtoteq;
    ...
    if (here->HSM2_corg == 1) {
      grg = here->HSM2_grg;
      mat.add(here->HSM2GgPtr, grg);
      mat.add(here->HSM2GPgPtr, -(grg));
      mat.add(here->HSM2GgpPtr, -(grg));
      mat.add(here->HSM2GPgpPtr, gcggb + grg + gIgtotg);
      mat.add(here->HSM2GPdpPtr, gcgdb + gIgtotd);
      mat.add(here->HSM2GPspPtr, gcgsb + gIgtots);
      mat.add(here->HSM2GPbpPtr, gcgbb + gIgtotb);
    } else {
      mat.add(here->HSM2GPgpPtr, gcggb + gIgtotg);
      mat.add(here->HSM2GPdpPtr, gcgdb + gIgtotd);
      mat.add(here->HSM2GPspPtr, gcgsb + gIgtots);
      mat.add(here->HSM2GPbpPtr, gcgbb + gIgtotb);
    }

    mat.add(here->HSM2DPdpPtr, here->HSM2drainConductance
      + here->HSM2_gds + here->HSM2_gbd + RevSum + gcddb + gbdpdp - gIdtotd);
    mat.add(here->HSM2DPdPtr, -(here->HSM2drainConductance));
    mat.add(here->HSM2DPgpPtr, gm + gcdgb + gbdpg - gIdtotg);
    mat.add(here->HSM2DPspPtr, -(here->HSM2_gds + FwdSum - gcdsb - gbdpsp + gIdtots));
    mat.add(here->HSM2DPbpPtr, -(gjbd - gmbs - gcdbb - gbdpb + gIdtotb));

    mat.add(here->HSM2DdpPtr, -(here->HSM2drainConductance));
    mat.add(here->HSM2DdPtr, here->HSM2drainConductance);

    mat.add(here->HSM2SPdpPtr, -(here->HSM2_gds + RevSum - gcsdb - gbspdp + gIstotd));
    mat.add(here->HSM2SPgpPtr, gcsgb - gm + gbspg - gIstotg);
    mat.add(here->HSM2SPspPtr, here->HSM2sourceConductance
      + here->HSM2_gds + here->HSM2_gbs + FwdSum + gcssb + gbspsp - gIstots);
    mat.add(here->HSM2SPsPtr, -(here->HSM2sourceConductance));
    mat.add(here->HSM2SPbpPtr, -(gjbs + gmbs - gcsbb - gbspb + gIstotb));

    mat.add(here->HSM2SspPtr, -(here->HSM2sourceConductance));
    mat.add(here->HSM2SsPtr, here->HSM2sourceConductance);

    mat.add(here->HSM2BPdpPtr, gcbdb - gjbd + gbbdp - gIbtotd);
    mat.add(here->HSM2BPgpPtr, gcbgb - here->HSM2_gbgs - gIbtotg);
    mat.add(here->HSM2BPspPtr, gcbsb - gjbs + gbbsp - gIbtots);
    mat.add(here->HSM2BPbpPtr, gjbd + gjbs + gcbbb - here->HSM2_gbbs - gIbtotb);

    if (model->HSM2_cogidl) {
      /* stamp GIDL */
      mat.add(here->HSM2DPdpPtr, here->HSM2_gigidlds);
      mat.add(here->HSM2DPgpPtr, here->HSM2_gigidlgs);
      mat.add(here->HSM2DPspPtr, -((here->HSM2_gigidlgs + 
			       here->HSM2_gigidlds + here->HSM2_gigidlbs)));
      mat.add(here->HSM2DPbpPtr, here->HSM2_gigidlbs);
      mat.add(here->HSM2BPdpPtr, -(here->HSM2_gigidlds));
      mat.add(here->HSM2BPgpPtr, -(here->HSM2_gigidlgs));
      mat.add(here->HSM2BPspPtr, (here->HSM2_gigidlgs + 
			       here->HSM2_gigidlds + here->HSM2_gigidlbs));
      mat.add(here->HSM2BPbpPtr, -(here->HSM2_gigidlbs));
      /* stamp GISL */
      mat.add(here->HSM2SPdpPtr, -((here->HSM2_gigislsd + 
			       here->HSM2_gigislgd + here->HSM2_gigislbd)));
      mat.add(here->HSM2SPgpPtr, here->HSM2_gigislgd);
      mat.add(here->HSM2SPspPtr, here->HSM2_gigislsd);
      mat.add(here->HSM2SPbpPtr, here->HSM2_gigislbd);
      mat.add(here->HSM2BPdpPtr, (here->HSM2_gigislgd + 
			       here->HSM2_gigislsd + here->HSM2_gigislbd));
      mat.add(here->HSM2BPgpPtr, -(here->HSM2_gigislgd));
      mat.add(here->HSM2BPspPtr, -(here->HSM2_gigislsd));
      mat.add(here->HSM2BPbpPtr, -(here->HSM2_gigislbd));
    }

    if (here->HSM2_corbnet) { /* body resistance network */
      mat.add(here->HSM2DPdbPtr, gcdbdb - here->HSM2_gbd);
      mat.add(here->HSM2SPsbPtr, -(here->HSM2_gbs - gcsbsb));

      mat.add(here->HSM2DBdpPtr, gcdbdb - here->HSM2_gbd);
      mat.add(here->HSM2DBdbPtr, here->HSM2_gbd - gcdbdb 
	+ here->HSM2_grbpd + here->HSM2_grbdb);
      mat.add(here->HSM2DBbpPtr, -(here->HSM2_grbpd));
      mat.add(here->HSM2DBbPtr, -(here->HSM2_grbdb));

      mat.add(here->HSM2BPdbPtr, -(here->HSM2_grbpd));
      mat.add(here->HSM2BPbPtr, -(here->HSM2_grbpb));
      mat.add(here->HSM2BPsbPtr, -(here->HSM2_grbps));
      mat.add(here->HSM2BPbpPtr, here->HSM2_grbpd + here->HSM2_grbps + here->HSM2_grbpb);
      
      mat.add(here->HSM2SBspPtr, gcsbsb - here->HSM2_gbs);
      mat.add(here->HSM2SBbpPtr, -(here->HSM2_grbps));
      mat.add(here->HSM2SBbPtr, -(here->HSM2_grbsb));
      mat.add(here->HSM2SBsbPtr, here->HSM2_gbs - gcsbsb 
	+ here->HSM2_grbps + here->HSM2_grbsb);

      mat.add(here->HSM2BdbPtr, -(here->HSM2_grbdb));
      mat.add(here->HSM2BbpPtr, -(here->HSM2_grbpb));
      mat.add(here->HSM2BsbPtr, -(here->HSM2_grbsb));
      mat.add(here->HSM2BbPtr, here->HSM2_grbsb + here->HSM2_grbdb + here->HSM2_grbpb);
    }
