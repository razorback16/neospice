...
int
BSIM3v32load (BSIM3v32Model *inModel, Shim::Ckt *ckt)
{
auto &mat = *ckt->mat;
BSIM3v32Model *model = inModel;
...
line900:
          ...
          T1 = qdef * here->BSIM3v32gtau;
          mat.add(here->BSIM3v32DdPtr, m * here->BSIM3v32drainConductance);
          mat.add(here->BSIM3v32GgPtr, m * (gcggb - ggtg));
          mat.add(here->BSIM3v32SsPtr, m * here->BSIM3v32sourceConductance);
          mat.add(here->BSIM3v32BbPtr, m * (here->BSIM3v32gbd + here->BSIM3v32gbs
                               - gcbgb - gcbdb - gcbsb - here->BSIM3v32gbbs));
          mat.add(here->BSIM3v32DPdpPtr, m * (here->BSIM3v32drainConductance
                                 + here->BSIM3v32gds + here->BSIM3v32gbd
                                 + RevSum + gcddb + dxpart * ggtd
                                 + T1 * ddxpart_dVd + gbdpdp));
          mat.add(here->BSIM3v32SPspPtr, m * (here->BSIM3v32sourceConductance
                                 + here->BSIM3v32gds + here->BSIM3v32gbs
                                 + FwdSum + gcssb + sxpart * ggts
                                 + T1 * dsxpart_dVs + gbspsp));
          mat.add(here->BSIM3v32DdpPtr, -(m * here->BSIM3v32drainConductance));
          mat.add(here->BSIM3v32GbPtr, -(m * (gcggb + gcgdb + gcgsb + ggtb)));
          mat.add(here->BSIM3v32GdpPtr, m * (gcgdb - ggtd));
          mat.add(here->BSIM3v32GspPtr, m * (gcgsb - ggts));
          mat.add(here->BSIM3v32SspPtr, -(m * here->BSIM3v32sourceConductance));
          mat.add(here->BSIM3v32BgPtr, m * (gcbgb - here->BSIM3v32gbgs));
          mat.add(here->BSIM3v32BdpPtr, m * (gcbdb - here->BSIM3v32gbd + gbbdp));
          mat.add(here->BSIM3v32BspPtr, m * (gcbsb - here->BSIM3v32gbs + gbbsp));
          mat.add(here->BSIM3v32DPdPtr, -(m * here->BSIM3v32drainConductance));
          mat.add(here->BSIM3v32DPgPtr, m * (Gm + gcdgb + dxpart * ggtg
                                + T1 * ddxpart_dVg + gbdpg));
          mat.add(here->BSIM3v32DPbPtr, -(m * (here->BSIM3v32gbd - Gmbs + gcdgb + gcddb
                                + gcdsb - dxpart * ggtb
                                - T1 * ddxpart_dVb - gbdpb)));
          mat.add(here->BSIM3v32DPspPtr, -(m * (here->BSIM3v32gds + FwdSum - gcdsb
                                - dxpart * ggts - T1 * ddxpart_dVs - gbdpsp)));
          mat.add(here->BSIM3v32SPgPtr, m * (gcsgb - Gm + sxpart * ggtg
                                + T1 * dsxpart_dVg + gbspg));
          mat.add(here->BSIM3v32SPsPtr, -(m * here->BSIM3v32sourceConductance));
          mat.add(here->BSIM3v32SPbPtr, -(m * (here->BSIM3v32gbs + Gmbs + gcsgb + gcsdb
                                + gcssb - sxpart * ggtb
                                - T1 * dsxpart_dVb - gbspb)));
          mat.add(here->BSIM3v32SPdpPtr, -(m * (here->BSIM3v32gds + RevSum - gcsdb
                                - sxpart * ggtd - T1 * dsxpart_dVd - gbspdp)));

          if (here->BSIM3v32nqsMod)
            {
              mat.add(here->BSIM3v32QqPtr, m * (gqdef + here->BSIM3v32gtau));

              mat.add(here->BSIM3v32DPqPtr, m * (dxpart * here->BSIM3v32gtau));
              mat.add(here->BSIM3v32SPqPtr, m * (sxpart * here->BSIM3v32gtau));
              mat.add(here->BSIM3v32GqPtr, -(m * here->BSIM3v32gtau));

              mat.add(here->BSIM3v32QgPtr, m * (ggtg - gcqgb));
              mat.add(here->BSIM3v32QdpPtr, m * (ggtd - gcqdb));
              mat.add(here->BSIM3v32QspPtr, m * (ggts - gcqsb));
              mat.add(here->BSIM3v32QbPtr, m * (ggtb - gcqbb));
            }
