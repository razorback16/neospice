...
struct BSIM3v32Instance {
    BSIM3v32Model *BSIM3v32modPtr;
    BSIM3v32Instance *BSIM3v32nextInstance;
    const char *BSIM3v32name;
    ...
    neospice::MatrixOffset BSIM3v32DdPtr{-1};
    neospice::MatrixOffset BSIM3v32GgPtr{-1};
    neospice::MatrixOffset BSIM3v32SsPtr{-1};
    neospice::MatrixOffset BSIM3v32BbPtr{-1};
    neospice::MatrixOffset BSIM3v32DPdpPtr{-1};
    neospice::MatrixOffset BSIM3v32SPspPtr{-1};
    neospice::MatrixOffset BSIM3v32DdpPtr{-1};
    neospice::MatrixOffset BSIM3v32GbPtr{-1};
    neospice::MatrixOffset BSIM3v32GdpPtr{-1};
    neospice::MatrixOffset BSIM3v32GspPtr{-1};
    neospice::MatrixOffset BSIM3v32SspPtr{-1};
    neospice::MatrixOffset BSIM3v32BdpPtr{-1};
    neospice::MatrixOffset BSIM3v32BspPtr{-1};
    neospice::MatrixOffset BSIM3v32DPspPtr{-1};
    neospice::MatrixOffset BSIM3v32DPdPtr{-1};
    neospice::MatrixOffset BSIM3v32BgPtr{-1};
    neospice::MatrixOffset BSIM3v32DPgPtr{-1};
    neospice::MatrixOffset BSIM3v32SPgPtr{-1};
    neospice::MatrixOffset BSIM3v32SPsPtr{-1};
    neospice::MatrixOffset BSIM3v32DPbPtr{-1};
    neospice::MatrixOffset BSIM3v32SPbPtr{-1};
    neospice::MatrixOffset BSIM3v32SPdpPtr{-1};

    neospice::MatrixOffset BSIM3v32QqPtr{-1};
    neospice::MatrixOffset BSIM3v32QdpPtr{-1};
    neospice::MatrixOffset BSIM3v32QgPtr{-1};
    neospice::MatrixOffset BSIM3v32QspPtr{-1};
    neospice::MatrixOffset BSIM3v32QbPtr{-1};
    neospice::MatrixOffset BSIM3v32DPqPtr{-1};
    neospice::MatrixOffset BSIM3v32GqPtr{-1};
    neospice::MatrixOffset BSIM3v32SPqPtr{-1};
    neospice::MatrixOffset BSIM3v32BqPtr{-1};
...
struct BSIM3v32Model {
    int BSIM3v32modType;
    BSIM3v32Model *BSIM3v32nextModel;
    BSIM3v32Instance *BSIM3v32instances;
    const char *BSIM3v32modName;

    /* --- end of generic struct BSIM3v32Model --- */
...
extern int BSIM3v32debug(BSIM3v32Model*, BSIM3v32Instance*, Shim::Ckt *, int);
extern int BSIM3v32checkModel(BSIM3v32Model*, BSIM3v32Instance*, Shim::Ckt *);

// --- Parameter tables and dispatchers (defined in devsup/mpar) ------
namespace Shim { struct IfParm; struct IfValue; }
extern Shim::IfParm BSIM3v32pTable[];
extern int BSIM3v32pTSize;
extern Shim::IfParm BSIM3v32mPTable[];
extern int BSIM3v32mPTSize;
int BSIM3v32mParam(int param, Shim::IfValue *value, BSIM3v32Model *model);
int BSIM3v32param(int param, Shim::IfValue *value, BSIM3v32Instance *inst, Shim::IfValue *select);
