...
/* ARGSUSED */
int
BSIM3v32temp (BSIM3v32Model *inModel, Shim::Ckt *ckt)
{
    ...
    {    Temp = ckt->CKTtemp;
              ...
              here = here->BSIM3v32nextInstance)
         {
              ...
              {   pParam = TMALLOC(struct bsim3v32SizeDependParam, 1);
                  ...
                  {
                      Shim::report_error(Shim::ERR_FATAL, "Fatal error(s) detected during BSIM3v32V3.2 parameter checking for %s in model %s", model->BSIM3v32modName, here->BSIM3v32name);
                      return Shim::E_BADPARM;
                  }
