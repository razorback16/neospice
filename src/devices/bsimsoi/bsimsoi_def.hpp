...
struct B4SOIInstance {
    B4SOIModel *B4SOImodPtr;
    B4SOIInstance *B4SOInextInstance;
    const char *B4SOIname;
...
/* v4.0 */
    neospice::MatrixOffset B4SOIDBdpPtr{-1};
    neospice::MatrixOffset B4SOIDBdbPtr{-1};
    neospice::MatrixOffset B4SOIDBbPtr{-1};
    neospice::MatrixOffset B4SOIDPdbPtr{-1};

    neospice::MatrixOffset B4SOISBspPtr{-1};
    neospice::MatrixOffset B4SOISBbPtr{-1};
    neospice::MatrixOffset B4SOISBsbPtr{-1};
    neospice::MatrixOffset B4SOISPsbPtr{-1};

    neospice::MatrixOffset B4SOIBsbPtr{-1};
    neospice::MatrixOffset B4SOIBdbPtr{-1};

    neospice::MatrixOffset B4SOIDgPtr{-1};         /* v4.0 for rdsMod =1 */
    neospice::MatrixOffset B4SOIDspPtr{-1};        /* v4.0 for rdsMod =1 */
    neospice::MatrixOffset B4SOIDbPtr{-1};         /* v4.0 for rdsMod =1 */
    neospice::MatrixOffset B4SOISdpPtr{-1};        /* v4.0 for rdsMod =1 */
    neospice::MatrixOffset B4SOISgPtr{-1};         /* v4.0 for rdsMod =1 */
    neospice::MatrixOffset B4SOISbPtr{-1};         /* v4.0 for rdsMod =1 */
/* v4.0 end */

    neospice::MatrixOffset B4SOIPgPtr{-1};         /* v4.1 for Ig_agbcp2 */
    neospice::MatrixOffset B4SOIGpPtr{-1};         /* v4.1 for Ig_agbcp2 */

/* v3.1  added for RF */
    neospice::MatrixOffset B4SOIGgmPtr{-1};
    neospice::MatrixOffset B4SOIGgePtr{-1};

    neospice::MatrixOffset B4SOIGMdpPtr{-1};
    neospice::MatrixOffset B4SOIGMgPtr{-1};
    neospice::MatrixOffset B4SOIGMspPtr{-1};
    neospice::MatrixOffset B4SOIGMgmPtr{-1};
    neospice::MatrixOffset B4SOIGMgePtr{-1};
    neospice::MatrixOffset B4SOIGMePtr{-1};
    neospice::MatrixOffset B4SOIGMbPtr{-1};

    neospice::MatrixOffset B4SOISPgmPtr{-1};
    neospice::MatrixOffset B4SOIDPgmPtr{-1};
    neospice::MatrixOffset B4SOIEgmPtr{-1};

    neospice::MatrixOffset B4SOIGEdpPtr{-1};
    neospice::MatrixOffset B4SOIGEgPtr{-1};
    neospice::MatrixOffset B4SOIGEgmPtr{-1};
    neospice::MatrixOffset B4SOIGEgePtr{-1};
    neospice::MatrixOffset B4SOIGEspPtr{-1};
    neospice::MatrixOffset B4SOIGEbPtr{-1};
/* v3.1 added for RF end */

    neospice::MatrixOffset B4SOIGePtr{-1};
    neospice::MatrixOffset B4SOIDPePtr{-1};
    neospice::MatrixOffset B4SOISPePtr{-1};

    neospice::MatrixOffset B4SOIEePtr{-1};
    neospice::MatrixOffset B4SOIEbPtr{-1};
    neospice::MatrixOffset B4SOIBePtr{-1};
    neospice::MatrixOffset B4SOIEgPtr{-1};
    neospice::MatrixOffset B4SOIEdpPtr{-1};
    neospice::MatrixOffset B4SOIEspPtr{-1};
    neospice::MatrixOffset B4SOITemptempPtr{-1};
    neospice::MatrixOffset B4SOITempdpPtr{-1};
    neospice::MatrixOffset B4SOITempspPtr{-1};
    neospice::MatrixOffset B4SOITempgPtr{-1};
    neospice::MatrixOffset B4SOITempbPtr{-1};
    neospice::MatrixOffset B4SOITempePtr{-1};   /* v3.0 */
    neospice::MatrixOffset B4SOIGtempPtr{-1};
    neospice::MatrixOffset B4SOIDPtempPtr{-1};
    neospice::MatrixOffset B4SOISPtempPtr{-1};
    neospice::MatrixOffset B4SOIEtempPtr{-1};
    neospice::MatrixOffset B4SOIBtempPtr{-1};
    neospice::MatrixOffset B4SOIPtempPtr{-1};
    neospice::MatrixOffset B4SOIBpPtr{-1};
    neospice::MatrixOffset B4SOIPbPtr{-1};
    neospice::MatrixOffset B4SOIPpPtr{-1};
    neospice::MatrixOffset B4SOIDdPtr{-1};
    neospice::MatrixOffset B4SOIGgPtr{-1};
    neospice::MatrixOffset B4SOISsPtr{-1};
    neospice::MatrixOffset B4SOIBbPtr{-1};
    neospice::MatrixOffset B4SOIDPdpPtr{-1};
    neospice::MatrixOffset B4SOISPspPtr{-1};
    neospice::MatrixOffset B4SOIDdpPtr{-1};
    neospice::MatrixOffset B4SOIGbPtr{-1};
    neospice::MatrixOffset B4SOIGdpPtr{-1};
    neospice::MatrixOffset B4SOIGspPtr{-1};
    neospice::MatrixOffset B4SOISspPtr{-1};
    neospice::MatrixOffset B4SOIBdpPtr{-1};
    neospice::MatrixOffset B4SOIBspPtr{-1};
    neospice::MatrixOffset B4SOIDPspPtr{-1};
    neospice::MatrixOffset B4SOIDPdPtr{-1};
    neospice::MatrixOffset B4SOIBgPtr{-1};
    neospice::MatrixOffset B4SOIDPgPtr{-1};
    neospice::MatrixOffset B4SOISPgPtr{-1};
    neospice::MatrixOffset B4SOISPsPtr{-1};
    neospice::MatrixOffset B4SOIDPbPtr{-1};
    neospice::MatrixOffset B4SOISPbPtr{-1};
    neospice::MatrixOffset B4SOISPdpPtr{-1};

    neospice::MatrixOffset B4SOIVbsPtr{-1};
    /* Debug */
    neospice::MatrixOffset B4SOIIdsPtr{-1};
    neospice::MatrixOffset B4SOIIcPtr{-1};
    neospice::MatrixOffset B4SOIIbsPtr{-1};
    neospice::MatrixOffset B4SOIIbdPtr{-1};
    neospice::MatrixOffset B4SOIIiiPtr{-1};
    neospice::MatrixOffset B4SOIIgPtr{-1};
    neospice::MatrixOffset B4SOIGiggPtr{-1};
    neospice::MatrixOffset B4SOIGigdPtr{-1};
    neospice::MatrixOffset B4SOIGigbPtr{-1};
    neospice::MatrixOffset B4SOIIgidlPtr{-1};
    neospice::MatrixOffset B4SOIItunPtr{-1};
    neospice::MatrixOffset B4SOIIbpPtr{-1};
    neospice::MatrixOffset B4SOICbbPtr{-1};
    neospice::MatrixOffset B4SOICbdPtr{-1};
    neospice::MatrixOffset B4SOICbgPtr{-1};
    neospice::MatrixOffset B4SOIqbPtr{-1};
    neospice::MatrixOffset B4SOIQbfPtr{-1};
    neospice::MatrixOffset B4SOIQjsPtr{-1};
    neospice::MatrixOffset B4SOIQjdPtr{-1};
...
struct B4SOIModel {
    int B4SOImodType;
    B4SOIModel *B4SOInextModel;
    B4SOIInstance *B4SOIinstances;
    const char *B4SOImodName;

    /* --- end of generic struct B4SOIModel --- */
...
#ifdef USE_OMP
    int B4SOIInstCount;
    B4SOIInstance **B4SOIInstanceArray;
#endif
...
extern int B4SOIdebug(B4SOIModel*, B4SOIInstance*, Shim::Ckt *, int);
extern int B4SOIcheckModel(B4SOIModel*, B4SOIInstance*, Shim::Ckt *);

// --- Parameter tables and dispatchers (defined in devsup/mpar) ------
namespace Shim { struct IfParm; struct IfValue; }
extern Shim::IfParm B4SOIpTable[];
extern int B4SOIpTSize;
extern Shim::IfParm B4SOImPTable[];
extern int B4SOImPTSize;
int B4SOImParam(int param, Shim::IfValue *value, B4SOIModel *model);
int B4SOIparam(int param, Shim::IfValue *value, B4SOIInstance *inst, Shim::IfValue *select);
