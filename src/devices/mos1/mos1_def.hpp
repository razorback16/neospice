...
struct MOS1Instance {
    MOS1Model *MOS1modPtr; /* backpointer to model */
    MOS1Instance *MOS1nextInstance;  /* pointer to next instance of
                                              *current model*/
    const char *MOS1name; /* pointer to character string naming this instance */
...
#define MOS1NSRCS     5     /* the number of MOS1FET noise sources*/
    ...
    neospice::MatrixOffset MOS1DdPtr{-1};      /* pointer to sparse matrix element at
                                     * (Drain node,drain node) */
    neospice::MatrixOffset MOS1GgPtr{-1};      /* pointer to sparse matrix element at
                                     * (gate node,gate node) */
    neospice::MatrixOffset MOS1SsPtr{-1};      /* pointer to sparse matrix element at
                                     * (source node,source node) */
    neospice::MatrixOffset MOS1BbPtr{-1};      /* pointer to sparse matrix element at
                                     * (bulk node,bulk node) */
    neospice::MatrixOffset MOS1DPdpPtr{-1};    /* pointer to sparse matrix element at
                                     * (drain prime node,drain prime node) */
    neospice::MatrixOffset MOS1SPspPtr{-1};    /* pointer to sparse matrix element at
                                     * (source prime node,source prime node) */
    neospice::MatrixOffset MOS1DdpPtr{-1};     /* pointer to sparse matrix element at
                                     * (drain node,drain prime node) */
    neospice::MatrixOffset MOS1GbPtr{-1};      /* pointer to sparse matrix element at
                                     * (gate node,bulk node) */
    neospice::MatrixOffset MOS1GdpPtr{-1};     /* pointer to sparse matrix element at
                                     * (gate node,drain prime node) */
    neospice::MatrixOffset MOS1GspPtr{-1};     /* pointer to sparse matrix element at
                                     * (gate node,source prime node) */
    neospice::MatrixOffset MOS1SspPtr{-1};     /* pointer to sparse matrix element at
                                     * (source node,source prime node) */
    neospice::MatrixOffset MOS1BdpPtr{-1};     /* pointer to sparse matrix element at
                                     * (bulk node,drain prime node) */
    neospice::MatrixOffset MOS1BspPtr{-1};     /* pointer to sparse matrix element at
                                     * (bulk node,source prime node) */
    neospice::MatrixOffset MOS1DPspPtr{-1};    /* pointer to sparse matrix element at
                                     * (drain prime node,source prime node) */
    neospice::MatrixOffset MOS1DPdPtr{-1};     /* pointer to sparse matrix element at
                                     * (drain prime node,drain node) */
    neospice::MatrixOffset MOS1BgPtr{-1};      /* pointer to sparse matrix element at
                                     * (bulk node,gate node) */
    neospice::MatrixOffset MOS1DPgPtr{-1};     /* pointer to sparse matrix element at
                                     * (drain prime node,gate node) */

    neospice::MatrixOffset MOS1SPgPtr{-1};     /* pointer to sparse matrix element at
                                     * (source prime node,gate node) */
    neospice::MatrixOffset MOS1SPsPtr{-1};     /* pointer to sparse matrix element at
                                     * (source prime node,source node) */
    neospice::MatrixOffset MOS1DPbPtr{-1};     /* pointer to sparse matrix element at
                                     * (drain prime node,bulk node) */
    neospice::MatrixOffset MOS1SPbPtr{-1};     /* pointer to sparse matrix element at
                                     * (source prime node,bulk node) */
    neospice::MatrixOffset MOS1SPdpPtr{-1};    /* pointer to sparse matrix element at
...
struct MOS1Model {       /* model structure for a resistor */
    int MOS1modType;    /* type index to this device type */
    MOS1Model *MOS1nextModel;    /* pointer to next possible model 
                                          *in linked list */
...
extern Shim::IfParm MOS1pTable[];
extern int MOS1pTSize;
extern Shim::IfParm MOS1mPTable[];
extern int MOS1mPTSize;
int MOS1mParam(int param, Shim::IfValue *value, MOS1Model *model);
int MOS1param(int param, Shim::IfValue *value, MOS1Instance *inst, Shim::IfValue *select);
