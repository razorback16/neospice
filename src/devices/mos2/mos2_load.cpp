...
int
MOS2load(MOS2Model *inModel, Shim::Ckt *ckt)
...
doneval:    
            ...
            if ( (here->MOS2off == 0)  || 
                ...
                if (Check == 1) {
                    ckt->CKTnoncon++;
		    ckt->CKTtroubleElt = (MOS2Instance *) here;
                }
            }
...
bypass:
	    ...
	    printf("%g %g %g %g %g\n", -gcgs, -gcgd, 0.0, -gcgs, 0.0);
             ...
             */
            auto& mat = *ckt->mat;
            mat.add(here->MOS2DdPtr, (here->MOS2drainConductance));
            mat.add(here->MOS2GgPtr, gcgd+gcgs+gcgb);
            mat.add(here->MOS2SsPtr, (here->MOS2sourceConductance));
            mat.add(here->MOS2BbPtr, (here->MOS2gbd+here->MOS2gbs+gcgb));
            mat.add(here->MOS2DPdpPtr, here->MOS2drainConductance+here->MOS2gds+
                    here->MOS2gbd+xrev*(here->MOS2gm+here->MOS2gmbs)+gcgd);
            mat.add(here->MOS2SPspPtr, here->MOS2sourceConductance+here->MOS2gds+
                    here->MOS2gbs+xnrm*(here->MOS2gm+here->MOS2gmbs)+gcgs);
            mat.add(here->MOS2DdpPtr, -(here->MOS2drainConductance));
            mat.add(here->MOS2GbPtr, -(gcgb));
            mat.add(here->MOS2GdpPtr, -(gcgd));
            mat.add(here->MOS2GspPtr, -(gcgs));
            mat.add(here->MOS2SspPtr, -(here->MOS2sourceConductance));
            mat.add(here->MOS2BgPtr, -(gcgb));
            mat.add(here->MOS2BdpPtr, -(here->MOS2gbd));
            mat.add(here->MOS2BspPtr, -(here->MOS2gbs));
            mat.add(here->MOS2DPdPtr, -(here->MOS2drainConductance));
            mat.add(here->MOS2DPgPtr, ((xnrm-xrev)*here->MOS2gm-gcgd));
            mat.add(here->MOS2DPbPtr, (-here->MOS2gbd+(xnrm-xrev)*here->MOS2gmbs));
            mat.add(here->MOS2DPspPtr, -(here->MOS2gds+xnrm*(here->MOS2gm+
                    here->MOS2gmbs)));
            mat.add(here->MOS2SPgPtr, -((xnrm-xrev)*here->MOS2gm+gcgs));
            mat.add(here->MOS2SPsPtr, -(here->MOS2sourceConductance));
