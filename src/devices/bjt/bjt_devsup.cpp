...
Shim::IfParm BJTpTable[] = { /* parameters */
...
Shim::IfParm BJTmPTable[] = { /* model parameters */
 ...
 IOP("c2",   BJT_MOD_ISE,  IF_REAL, "B-E leakage saturation current (alias of ise)"),
 ...
 IOP("c4",   BJT_MOD_ISC,  IF_REAL, "B-C leakage saturation current (alias of isc)"),
 ...
 IOP("nk",  BJT_MOD_NKF, IF_REAL, "NK High current beta rolloff exponent (alias of nkf)"),
