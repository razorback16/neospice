...
struct DIOInstance {
    DIOModel *DIOmodPtr;    /* backpointer to model */
    DIOInstance *DIOnextInstance;   /* pointer to next instance of 
                                             * current model*/
    const char *DIOname;      /* pointer to character string naming this instance */
    ...
    neospice::MatrixOffset DIOposPosPrimePtr{-1};      /* pointer to sparse matrix at 
                                     * (positive,positive prime) */
    neospice::MatrixOffset DIOnegPosPrimePtr{-1};      /* pointer to sparse matrix at 
                                     * (negative,positive prime) */
    neospice::MatrixOffset DIOposPrimePosPtr{-1};      /* pointer to sparse matrix at 
                                     * (positive prime,positive) */
    neospice::MatrixOffset DIOposPrimeNegPtr{-1};      /* pointer to sparse matrix at 
                                     * (positive prime,negative) */
    neospice::MatrixOffset DIOposPosPtr{-1};   /* pointer to sparse matrix at 
                             * (positive,positive) */
    neospice::MatrixOffset DIOnegNegPtr{-1};   /* pointer to sparse matrix at 
                             * (negative,negative) */
    neospice::MatrixOffset DIOposPrimePosPrimePtr{-1}; /* pointer to sparse matrix at 
...
struct DIOModel {       /* model structure for a diode */
    int DIOmodType; /* type index of this device type */
    DIOModel *DIOnextModel; /* pointer to next possible model in 
                                     * linked list */
...
extern Shim::IfParm DIOpTable[];
extern int DIOpTSize;
extern Shim::IfParm DIOmPTable[];
extern int DIOmPTSize;
int DIOmParam(int param, Shim::IfValue *value, DIOModel *model);
int DIOparam(int param, Shim::IfValue *value, DIOInstance *inst, Shim::IfValue *select);
