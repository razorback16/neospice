...
struct HSMHVInstance {

  HSMHVModel *HSMHVmodPtr;           /* pointer to model */
  HSMHVInstance *HSMHVnextInstance;  /* pointer to next instance */
  const char *HSMHVname;             /* instance name */
  int HSMHVstates;                   /* index into state table */
...
#define XDIM 14
  ...
  neospice::MatrixOffset HSMHVGgPtr{-1};   /* pointer to sparse matrix element at (gate node,gate node) */
  neospice::MatrixOffset HSMHVGgpPtr{-1};  /* pointer to sparse matrix element at (gate node,gate prime node) */
  /* double *HSMHVGdpPtr;	not used */
  /* double *HSMHVGspPtr;	not used */
  /* double *HSMHVGbpPtr;	not used */

  neospice::MatrixOffset HSMHVGPgPtr{-1};  /* pointer to sparse matrix element at (gate prime node,gate node) */
  neospice::MatrixOffset HSMHVGPgpPtr{-1}; /* pointer to sparse matrix element at (gate prime node,gate prime node) */
  neospice::MatrixOffset HSMHVGPdpPtr{-1}; /* pointer to sparse matrix element at (gate prime node,drain prime node) */
  neospice::MatrixOffset HSMHVGPspPtr{-1}; /* pointer to sparse matrix element at (gate prime node,source prime node) */
  neospice::MatrixOffset HSMHVGPbpPtr{-1}; /* pointer to sparse matrix element at (gate prime node,bulk prime node) */

  neospice::MatrixOffset HSMHVDPdPtr{-1};  /* pointer to sparse matrix element at (drain prime node,drain node) */
  neospice::MatrixOffset HSMHVDPdpPtr{-1}; /* pointer to sparse matrix element at (drain prime node,drain prime node) */
  neospice::MatrixOffset HSMHVDPgpPtr{-1}; /* pointer to sparse matrix element at (drain prime node,gate prime node) */
  neospice::MatrixOffset HSMHVDPspPtr{-1}; /* pointer to sparse matrix element at (drain prime node,source prime node) */
  neospice::MatrixOffset HSMHVDPbpPtr{-1}; /* pointer to sparse matrix element at (drain prime node,bulk prime node) */

  neospice::MatrixOffset HSMHVDdPtr{-1};   /* pointer to sparse matrix element at (Drain node,drain node) */
  neospice::MatrixOffset HSMHVDdpPtr{-1};  /* pointer to sparse matrix element at (drain node,drain prime node) */
  neospice::MatrixOffset HSMHVDspPtr{-1};  /* pointer to sparse matrix element at (drain node,source prime node) */
  neospice::MatrixOffset HSMHVDdbPtr{-1};  /* pointer to sparse matrix element at (drain node,drain body node) */

  neospice::MatrixOffset HSMHVSPsPtr{-1};  /* pointer to sparse matrix element at (source prime node,source node) */
  neospice::MatrixOffset HSMHVSPspPtr{-1}; /* pointer to sparse matrix element at (source prime node,source prime node) */
  neospice::MatrixOffset HSMHVSPgpPtr{-1}; /* pointer to sparse matrix element at (source prime node,gate prime node) */
  neospice::MatrixOffset HSMHVSPdpPtr{-1}; /* pointer to sparse matrix element at (source prime node,drain prime node) */
  neospice::MatrixOffset HSMHVSPbpPtr{-1}; /* pointer to sparse matrix element at (source prime node,bulk prime node) */

  neospice::MatrixOffset HSMHVSsPtr{-1};   /* pointer to sparse matrix element at (source node,source node) */
  neospice::MatrixOffset HSMHVSspPtr{-1};  /* pointer to sparse matrix element at (source node,source prime node) */
  neospice::MatrixOffset HSMHVSdpPtr{-1};  /* pointer to sparse matrix element at (source node,drain prime node) */
  neospice::MatrixOffset HSMHVSsbPtr{-1};  /* pointer to sparse matrix element at (source node,source body node) */

  neospice::MatrixOffset HSMHVBPgpPtr{-1}; /* pointer to sparse matrix element at (bulk prime node,gate prime node) */
  neospice::MatrixOffset HSMHVBPbpPtr{-1}; /* pointer to sparse matrix element at (bulk prime node,bulk prime node) */
  neospice::MatrixOffset HSMHVBPdPtr{-1};  /* pointer to sparse matrix element at (bulk prime node,drain node) */
  neospice::MatrixOffset HSMHVBPdpPtr{-1}; /* pointer to sparse matrix element at (bulk prime node,drain prime node) */
  neospice::MatrixOffset HSMHVBPspPtr{-1}; /* pointer to sparse matrix element at (bulk prime node,source prime node) */
  neospice::MatrixOffset HSMHVBPsPtr{-1};  /* pointer to sparse matrix element at (bulk prime node,source node) */
  neospice::MatrixOffset HSMHVBPbPtr{-1};  /* pointer to sparse matrix element at (bulk prime node,bulk node) */
  neospice::MatrixOffset HSMHVBPdbPtr{-1}; /* pointer to sparse matrix element at (bulk prime node,source body node) */
  neospice::MatrixOffset HSMHVBPsbPtr{-1}; /* pointer to sparse matrix element at (bulk prime node,source body node) */

  neospice::MatrixOffset HSMHVDBdPtr{-1};  /* pointer to sparse matrix element at (drain body node,drain node) */
  neospice::MatrixOffset HSMHVDBdbPtr{-1}; /* pointer to sparse matrix element at (drain body node,drain body node) */
  neospice::MatrixOffset HSMHVDBbpPtr{-1}; /* pointer to sparse matrix element at (drain body node,bulk prime node) */
  /* double *HSMHVDBbPtr;	not used */
  
  neospice::MatrixOffset HSMHVSBsPtr{-1};  /* pointer to sparse matrix element at (source body node,source node) */
  neospice::MatrixOffset HSMHVSBbpPtr{-1}; /* pointer to sparse matrix element at (source body node,bulk prime node) */
  /* double *HSMHVSBbPtr;	not used */
  neospice::MatrixOffset HSMHVSBsbPtr{-1}; /* pointer to sparse matrix element at (source body node,source body node) */

  /* double *HSMHVBsbPtr;	not used */
  neospice::MatrixOffset HSMHVBbpPtr{-1};  /* pointer to sparse matrix element at (bulk node,bulk prime node) */
  /* double *HSMHVBdbPtr;	not used */
  neospice::MatrixOffset HSMHVBbPtr{-1};   /* pointer to sparse matrix element at (bulk node,bulk node) */
  
  neospice::MatrixOffset HSMHVTemptempPtr{-1}; /* pointer to sparse matrix element at (temp node, temp node) */
  neospice::MatrixOffset HSMHVTempdPtr{-1};    /* pointer to sparse matrix element at (temp node, drain node) */
  neospice::MatrixOffset HSMHVTempdpPtr{-1};   /* pointer to sparse matrix element at (temp node, drain prime node) */
  neospice::MatrixOffset HSMHVTempsPtr{-1};    /* pointer to sparse matrix element at (temp node, source node) */
  neospice::MatrixOffset HSMHVTempspPtr{-1};   /* pointer to sparse matrix element at (temp node, source prime node) */
  /* double *HSMHVTempgPtr;	not used */
  neospice::MatrixOffset HSMHVTempgpPtr{-1};   /* pointer to sparse matrix element at (temp node, gate prime node) */
  /* double *HSMHVTempbPtr;	not used */
  neospice::MatrixOffset HSMHVTempbpPtr{-1};   /* pointer to sparse matrix element at (temp node, bulk prime node) */
  /* double *HSMHVGtempPtr;	not used */
  neospice::MatrixOffset HSMHVGPtempPtr{-1};   /* pointer to sparse matrix element at (gate prime node, temp node) */
  neospice::MatrixOffset HSMHVDPtempPtr{-1};   /* pointer to sparse matrix element at (drain prime node, temp node) */
  neospice::MatrixOffset HSMHVSPtempPtr{-1};   /* pointer to sparse matrix element at (source prime node, temp node) */
  /* double *HSMHVBtempPtr;	not used */
  neospice::MatrixOffset HSMHVBPtempPtr{-1};   /* pointer to sparse matrix element at (bulk prime node, temp node) */
  neospice::MatrixOffset HSMHVDBtempPtr{-1};   /* pointer to sparse matrix element at (drain bulk node, temp node) */
  neospice::MatrixOffset HSMHVSBtempPtr{-1};   /* pointer to sparse matrix element at (source bulk node, temp node) */

  neospice::MatrixOffset HSMHVDgpPtr{-1};      /* pointer to sparse matrix element at (drain node, gate prime node) */
  neospice::MatrixOffset HSMHVDsPtr{-1};       /* pointer to sparse matrix element at (drain node, source node) */
  neospice::MatrixOffset HSMHVDbpPtr{-1};      /* pointer to sparse matrix element at (drain node, bulk prime node) */
  neospice::MatrixOffset HSMHVDtempPtr{-1};    /* pointer to sparse matrix element at (drain node, temp node) */
  neospice::MatrixOffset HSMHVDPsPtr{-1};      /* pointer to sparse matrix element at (drain prime node, source node) */
  neospice::MatrixOffset HSMHVGPdPtr{-1};      /* pointer to sparse matrix element at (gate prime node, drain node) */
  neospice::MatrixOffset HSMHVGPsPtr{-1};      /* pointer to sparse matrix element at (gate prime node, source node) */
  neospice::MatrixOffset HSMHVSdPtr{-1};       /* pointer to sparse matrix element at (source node, drain node) */
  neospice::MatrixOffset HSMHVSgpPtr{-1};      /* pointer to sparse matrix element at (source node, gate prime node) */
  neospice::MatrixOffset HSMHVSbpPtr{-1};      /* pointer to sparse matrix element at (source node, bulk prime node) */
  neospice::MatrixOffset HSMHVStempPtr{-1};    /* pointer to sparse matrix element at (source node, temp node) */
  neospice::MatrixOffset HSMHVSPdPtr{-1};      /* pointer to sparse matrix element at (source prime node, drain node) */

  /* nqs related pointers */
  neospice::MatrixOffset HSMHVDPqiPtr{-1};     /* pointer to sparse matrix element at (drain prime node, qi_nqs node) */
  neospice::MatrixOffset HSMHVGPqiPtr{-1};     /* pointer to sparse matrix element at (gate prime node, qi_nqs node) */
  neospice::MatrixOffset HSMHVGPqbPtr{-1};     /* pointer to sparse matrix element at (gate prime node, qb_nqs node) */
  neospice::MatrixOffset HSMHVSPqiPtr{-1};     /* pointer to sparse matrix element at (source prime node, qi_nqs node) */
  neospice::MatrixOffset HSMHVBPqbPtr{-1};     /* pointer to sparse matrix element at (bulk prime node, qb_nqs node) */
  neospice::MatrixOffset HSMHVQIdpPtr{-1};     /* pointer to sparse matrix element at (qi_nqs node, drain prime node) */
  neospice::MatrixOffset HSMHVQIgpPtr{-1};     /* pointer to sparse matrix element at (qi_nqs node, gate prime node) */
  neospice::MatrixOffset HSMHVQIspPtr{-1};     /* pointer to sparse matrix element at (qi_nqs node, source prime node) */
  neospice::MatrixOffset HSMHVQIbpPtr{-1};     /* pointer to sparse matrix element at (qi_nqs node, bulk prime node) */
  neospice::MatrixOffset HSMHVQIqiPtr{-1};     /* pointer to sparse matrix element at (qi_nqs node, qi_nqs node) */
  neospice::MatrixOffset HSMHVQBdpPtr{-1};     /* pointer to sparse matrix element at (qb_nqs node, drain prime node) */
  neospice::MatrixOffset HSMHVQBgpPtr{-1};     /* pointer to sparse matrix element at (qb_nqs node, gate prime node) */
  neospice::MatrixOffset HSMHVQBspPtr{-1};     /* pointer to sparse matrix element at (qb_nqs node, source prime node) */
  neospice::MatrixOffset HSMHVQBbpPtr{-1};     /* pointer to sparse matrix element at (qb_nqs node, bulk prime node) */
  neospice::MatrixOffset HSMHVQBqbPtr{-1};     /* pointer to sparse matrix element at (qb_nqs node, qb_nqs node) */
  neospice::MatrixOffset HSMHVQItempPtr{-1};   /* pointer to sparse matrix element at (qi_nqs node, temp node) */
  neospice::MatrixOffset HSMHVQBtempPtr{-1};   /* pointer to sparse matrix element at (qb_nqs node, temp node) */

  /* Substrate effect related pointers */
  neospice::MatrixOffset HSMHVDsubPtr{-1};     /* pointer to sparse matrix element at (drain node, substrate node) */
  neospice::MatrixOffset HSMHVDPsubPtr{-1};    /* pointer to sparse matrix element at (drain prime node, substrate node) */
  neospice::MatrixOffset HSMHVSsubPtr{-1};     /* pointer to sparse matrix element at (source node, substrate node) */
  neospice::MatrixOffset HSMHVSPsubPtr{-1};    /* pointer to sparse matrix element at (source prime node, substrate node) */
...
struct HSMHVModel {     /* model structure for a resistor */

  int HSMHVmodType;
  HSMHVModel *HSMHVnextModel;
  HSMHVInstance *HSMHVinstances;
  const char *HSMHVmodName;
  ...
  const char *HSMHV_version;           /* model version */
...
extern void HSMHVevaluate(double,double,double,HSMHVInstance*,HSMHVModel*,
        ...
        double*, double*, double*, double*, double*, double*, double*, 
        double*, double*, double*, double*, Shim::Ckt *);
*/

// --- Parameter tables and dispatchers (defined in devsup/mpar) ------
namespace Shim { struct IfParm; struct IfValue; }
extern Shim::IfParm HSMHVpTable[];
extern int HSMHVpTSize;
extern Shim::IfParm HSMHVmPTable[];
extern int HSMHVmPTSize;
int HSMHVmParam(int param, Shim::IfValue *value, HSMHVModel *model);
int HSMHVparam(int param, Shim::IfValue *value, HSMHVInstance *inst, Shim::IfValue *select);

// --- Compatibility macros for v2 code that uses function-style access ------
#define HSMHVnextInstance(inst)  ((inst)->HSMHVnextInstance)
#define HSMHVnextModel(mod)     ((mod)->HSMHVnextModel)
#define HSMHVinstances(mod)     ((mod)->HSMHVinstances)
...
int HSMHVevaluate(double Vdse, double Vgse, double Vbse,
                  double Vds, double Vgs, double Vbs,
                  double vbs_jct, double vbd_jct, double Vsubs,
                  double Vddp, double deltemp,
                  HSMHVInstance *here, HSMHVModel *model, Shim::Ckt *ckt);
int HSMHVdio(double vbs_jct, double vbd_jct, double deltemp,
             HSMHVInstance *here, HSMHVModel *model, Shim::Ckt *ckt);
int HSMHVrdrift(double Vddp, double Vds, double Vbs, double Vsubs,
                double deltemp, HSMHVInstance *here, HSMHVModel *model, Shim::Ckt *ckt);
