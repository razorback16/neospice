...
struct MOS9Instance {
    MOS9Model *MOS9modPtr;  /* backpointer to model */
    MOS9Instance *MOS9nextInstance;  /* pointer to next instance of 
                                              *current model*/
    const char *MOS9name; /* pointer to character string naming this instance */
    ...
    neospice::MatrixOffset MOS9DdPtr{-1};      /* pointer to sparse matrix element at
                                     * (Drain node,drain node) */
    neospice::MatrixOffset MOS9GgPtr{-1};      /* pointer to sparse matrix element at
                                     * (gate node,gate node) */
    neospice::MatrixOffset MOS9SsPtr{-1};      /* pointer to sparse matrix element at
                                     * (source node,source node) */
    neospice::MatrixOffset MOS9BbPtr{-1};      /* pointer to sparse matrix element at
                                     * (bulk node,bulk node) */
    neospice::MatrixOffset MOS9DPdpPtr{-1};    /* pointer to sparse matrix element at
                                     * (drain prime node,drain prime node) */
    neospice::MatrixOffset MOS9SPspPtr{-1};    /* pointer to sparse matrix element at
                                     * (source prime node,source prime node) */
    neospice::MatrixOffset MOS9DdpPtr{-1};     /* pointer to sparse matrix element at
                                     * (drain node,drain prime node) */
    neospice::MatrixOffset MOS9GbPtr{-1};      /* pointer to sparse matrix element at
                                     * (gate node,bulk node) */
    neospice::MatrixOffset MOS9GdpPtr{-1};     /* pointer to sparse matrix element at
                                     * (gate node,drain prime node) */
    neospice::MatrixOffset MOS9GspPtr{-1};     /* pointer to sparse matrix element at
                                     * (gate node,source prime node) */
    neospice::MatrixOffset MOS9SspPtr{-1};     /* pointer to sparse matrix element at
                                     * (source node,source prime node) */
    neospice::MatrixOffset MOS9BdpPtr{-1};     /* pointer to sparse matrix element at
                                     * (bulk node,drain prime node) */
    neospice::MatrixOffset MOS9BspPtr{-1};     /* pointer to sparse matrix element at
                                     * (bulk node,source prime node) */
    neospice::MatrixOffset MOS9DPspPtr{-1};    /* pointer to sparse matrix element at
                                     * (drain prime node,source prime node) */
    neospice::MatrixOffset MOS9DPdPtr{-1};     /* pointer to sparse matrix element at
                                     * (drain prime node,drain node) */
    neospice::MatrixOffset MOS9BgPtr{-1};      /* pointer to sparse matrix element at
                                     * (bulk node,gate node) */
    neospice::MatrixOffset MOS9DPgPtr{-1};     /* pointer to sparse matrix element at
                                     * (drain prime node,gate node) */

    neospice::MatrixOffset MOS9SPgPtr{-1};     /* pointer to sparse matrix element at
                                     * (source prime node,gate node) */
    neospice::MatrixOffset MOS9SPsPtr{-1};     /* pointer to sparse matrix element at
                                     * (source prime node,source node) */
    neospice::MatrixOffset MOS9DPbPtr{-1};     /* pointer to sparse matrix element at
                                     * (drain prime node,bulk node) */
    neospice::MatrixOffset MOS9SPbPtr{-1};     /* pointer to sparse matrix element at
                                     * (source prime node,bulk node) */
    neospice::MatrixOffset MOS9SPdpPtr{-1};    /* pointer to sparse matrix element at
...
struct MOS9Model {       /* model structure for a resistor */
    int MOS9modType;    /* type index of this device type */
    MOS9Model *MOS9nextModel;    /* pointer to next possible model 
                                          *in linked list */
    MOS9Instance * MOS9instances; /* pointer to list of instances 
                                   * that have this model */
    const char *MOS9modName;       /* pointer to character string naming this model */

    /* --- end of generic struct MOS9Model --- */
...
extern Shim::IfParm MOS9pTable[];
extern int MOS9pTSize;
extern Shim::IfParm MOS9mPTable[];
extern int MOS9mPTSize;
int MOS9mParam(int param, Shim::IfValue *value, MOS9Model *model);
int MOS9param(int param, Shim::IfValue *value, MOS9Instance *inst, Shim::IfValue *select);
