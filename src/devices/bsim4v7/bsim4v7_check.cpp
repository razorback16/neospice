 ...
 *
 * Mechanical translation to C++ by neospice Z-port Task 8.
 * Original: third_party/bsim4_4.7.0/code/b4check.c (parameter range checker)
 **********/
...
int
BSIM4checkModel(BSIM4v7Model *model, BSIM4v7Instance *here, Shim::Ckt *ckt)
{
