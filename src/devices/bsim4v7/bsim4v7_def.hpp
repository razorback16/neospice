...
// Forward declaration — Model struct is defined later in this header.
struct BSIM4v7Model;

// UCB noisedef.h constant (stripped UCB include, retained verbatim here so
// BSIM4v7Instance::BSIM4nVar preserves its original shape).
#ifndef NSTATVARS
#define NSTATVARS 3
#endif
...
{
    BSIM4v7Model *BSIM4modPtr;
    BSIM4v7Instance *BSIM4nextInstance;
    const char *BSIM4name;
    ...
    neospice::MatrixOffset BSIM4DPdPtr;
    neospice::MatrixOffset BSIM4DPdpPtr;
    neospice::MatrixOffset BSIM4DPgpPtr;
    neospice::MatrixOffset BSIM4DPgmPtr;
    neospice::MatrixOffset BSIM4DPspPtr;
    neospice::MatrixOffset BSIM4DPbpPtr;
    neospice::MatrixOffset BSIM4DPdbPtr;

    neospice::MatrixOffset BSIM4DdPtr;
    neospice::MatrixOffset BSIM4DdpPtr;

    neospice::MatrixOffset BSIM4GPdpPtr;
    neospice::MatrixOffset BSIM4GPgpPtr;
    neospice::MatrixOffset BSIM4GPgmPtr;
    neospice::MatrixOffset BSIM4GPgePtr;
    neospice::MatrixOffset BSIM4GPspPtr;
    neospice::MatrixOffset BSIM4GPbpPtr;

    neospice::MatrixOffset BSIM4GMdpPtr;
    neospice::MatrixOffset BSIM4GMgpPtr;
    neospice::MatrixOffset BSIM4GMgmPtr;
    neospice::MatrixOffset BSIM4GMgePtr;
    neospice::MatrixOffset BSIM4GMspPtr;
    neospice::MatrixOffset BSIM4GMbpPtr;

    neospice::MatrixOffset BSIM4GEdpPtr;
    neospice::MatrixOffset BSIM4GEgpPtr;
    neospice::MatrixOffset BSIM4GEgmPtr;
    neospice::MatrixOffset BSIM4GEgePtr;
    neospice::MatrixOffset BSIM4GEspPtr;
    neospice::MatrixOffset BSIM4GEbpPtr;

    neospice::MatrixOffset BSIM4SPdpPtr;
    neospice::MatrixOffset BSIM4SPgpPtr;
    neospice::MatrixOffset BSIM4SPgmPtr;
    neospice::MatrixOffset BSIM4SPsPtr;
    neospice::MatrixOffset BSIM4SPspPtr;
    neospice::MatrixOffset BSIM4SPbpPtr;
    neospice::MatrixOffset BSIM4SPsbPtr;

    neospice::MatrixOffset BSIM4SspPtr;
    neospice::MatrixOffset BSIM4SsPtr;

    neospice::MatrixOffset BSIM4BPdpPtr;
    neospice::MatrixOffset BSIM4BPgpPtr;
    neospice::MatrixOffset BSIM4BPgmPtr;
    neospice::MatrixOffset BSIM4BPspPtr;
    neospice::MatrixOffset BSIM4BPdbPtr;
    neospice::MatrixOffset BSIM4BPbPtr;
    neospice::MatrixOffset BSIM4BPsbPtr;
    neospice::MatrixOffset BSIM4BPbpPtr;

    neospice::MatrixOffset BSIM4DBdpPtr;
    neospice::MatrixOffset BSIM4DBdbPtr;
    neospice::MatrixOffset BSIM4DBbpPtr;
    neospice::MatrixOffset BSIM4DBbPtr;

    neospice::MatrixOffset BSIM4SBspPtr;
    neospice::MatrixOffset BSIM4SBbpPtr;
    neospice::MatrixOffset BSIM4SBbPtr;
    neospice::MatrixOffset BSIM4SBsbPtr;

    neospice::MatrixOffset BSIM4BdbPtr;
    neospice::MatrixOffset BSIM4BbpPtr;
    neospice::MatrixOffset BSIM4BsbPtr;
    neospice::MatrixOffset BSIM4BbPtr;

    neospice::MatrixOffset BSIM4DgpPtr;
    neospice::MatrixOffset BSIM4DspPtr;
    neospice::MatrixOffset BSIM4DbpPtr;
    neospice::MatrixOffset BSIM4SdpPtr;
    neospice::MatrixOffset BSIM4SgpPtr;
    neospice::MatrixOffset BSIM4SbpPtr;

    neospice::MatrixOffset BSIM4QdpPtr;
    neospice::MatrixOffset BSIM4QgpPtr;
    neospice::MatrixOffset BSIM4QspPtr;
    neospice::MatrixOffset BSIM4QbpPtr;
    neospice::MatrixOffset BSIM4QqPtr;
    neospice::MatrixOffset BSIM4DPqPtr;
    neospice::MatrixOffset BSIM4GPqPtr;
    neospice::MatrixOffset BSIM4SPqPtr;
...
{
    int BSIM4modType;
    BSIM4v7Model *BSIM4nextModel;
    BSIM4v7Instance *BSIM4instances;
    const char *BSIM4modName; 
    int BSIM4type;
