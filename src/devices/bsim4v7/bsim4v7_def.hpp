...
struct BSIM4v7Instance {
    BSIM4v7Model *BSIM4v7modPtr;
    BSIM4v7Instance *BSIM4v7nextInstance;
    const char *BSIM4v7name;
    ...
    neospice::MatrixOffset BSIM4v7DPdPtr{-1};
    neospice::MatrixOffset BSIM4v7DPdpPtr{-1};
    neospice::MatrixOffset BSIM4v7DPgpPtr{-1};
    neospice::MatrixOffset BSIM4v7DPgmPtr{-1};
    neospice::MatrixOffset BSIM4v7DPspPtr{-1};
    neospice::MatrixOffset BSIM4v7DPbpPtr{-1};
    neospice::MatrixOffset BSIM4v7DPdbPtr{-1};

    neospice::MatrixOffset BSIM4v7DdPtr{-1};
    neospice::MatrixOffset BSIM4v7DdpPtr{-1};

    neospice::MatrixOffset BSIM4v7GPdpPtr{-1};
    neospice::MatrixOffset BSIM4v7GPgpPtr{-1};
    neospice::MatrixOffset BSIM4v7GPgmPtr{-1};
    neospice::MatrixOffset BSIM4v7GPgePtr{-1};
    neospice::MatrixOffset BSIM4v7GPspPtr{-1};
    neospice::MatrixOffset BSIM4v7GPbpPtr{-1};

    neospice::MatrixOffset BSIM4v7GMdpPtr{-1};
    neospice::MatrixOffset BSIM4v7GMgpPtr{-1};
    neospice::MatrixOffset BSIM4v7GMgmPtr{-1};
    neospice::MatrixOffset BSIM4v7GMgePtr{-1};
    neospice::MatrixOffset BSIM4v7GMspPtr{-1};
    neospice::MatrixOffset BSIM4v7GMbpPtr{-1};

    neospice::MatrixOffset BSIM4v7GEdpPtr{-1};
    neospice::MatrixOffset BSIM4v7GEgpPtr{-1};
    neospice::MatrixOffset BSIM4v7GEgmPtr{-1};
    neospice::MatrixOffset BSIM4v7GEgePtr{-1};
    neospice::MatrixOffset BSIM4v7GEspPtr{-1};
    neospice::MatrixOffset BSIM4v7GEbpPtr{-1};

    neospice::MatrixOffset BSIM4v7SPdpPtr{-1};
    neospice::MatrixOffset BSIM4v7SPgpPtr{-1};
    neospice::MatrixOffset BSIM4v7SPgmPtr{-1};
    neospice::MatrixOffset BSIM4v7SPsPtr{-1};
    neospice::MatrixOffset BSIM4v7SPspPtr{-1};
    neospice::MatrixOffset BSIM4v7SPbpPtr{-1};
    neospice::MatrixOffset BSIM4v7SPsbPtr{-1};

    neospice::MatrixOffset BSIM4v7SspPtr{-1};
    neospice::MatrixOffset BSIM4v7SsPtr{-1};

    neospice::MatrixOffset BSIM4v7BPdpPtr{-1};
    neospice::MatrixOffset BSIM4v7BPgpPtr{-1};
    neospice::MatrixOffset BSIM4v7BPgmPtr{-1};
    neospice::MatrixOffset BSIM4v7BPspPtr{-1};
    neospice::MatrixOffset BSIM4v7BPdbPtr{-1};
    neospice::MatrixOffset BSIM4v7BPbPtr{-1};
    neospice::MatrixOffset BSIM4v7BPsbPtr{-1};
    neospice::MatrixOffset BSIM4v7BPbpPtr{-1};

    neospice::MatrixOffset BSIM4v7DBdpPtr{-1};
    neospice::MatrixOffset BSIM4v7DBdbPtr{-1};
    neospice::MatrixOffset BSIM4v7DBbpPtr{-1};
    neospice::MatrixOffset BSIM4v7DBbPtr{-1};

    neospice::MatrixOffset BSIM4v7SBspPtr{-1};
    neospice::MatrixOffset BSIM4v7SBbpPtr{-1};
    neospice::MatrixOffset BSIM4v7SBbPtr{-1};
    neospice::MatrixOffset BSIM4v7SBsbPtr{-1};

    neospice::MatrixOffset BSIM4v7BdbPtr{-1};
    neospice::MatrixOffset BSIM4v7BbpPtr{-1};
    neospice::MatrixOffset BSIM4v7BsbPtr{-1};
    neospice::MatrixOffset BSIM4v7BbPtr{-1};

    neospice::MatrixOffset BSIM4v7DgpPtr{-1};
    neospice::MatrixOffset BSIM4v7DspPtr{-1};
    neospice::MatrixOffset BSIM4v7DbpPtr{-1};
    neospice::MatrixOffset BSIM4v7SdpPtr{-1};
    neospice::MatrixOffset BSIM4v7SgpPtr{-1};
    neospice::MatrixOffset BSIM4v7SbpPtr{-1};

    neospice::MatrixOffset BSIM4v7QdpPtr{-1};
    neospice::MatrixOffset BSIM4v7QgpPtr{-1};
    neospice::MatrixOffset BSIM4v7QspPtr{-1};
    neospice::MatrixOffset BSIM4v7QbpPtr{-1};
    neospice::MatrixOffset BSIM4v7QqPtr{-1};
    neospice::MatrixOffset BSIM4v7DPqPtr{-1};
    neospice::MatrixOffset BSIM4v7GPqPtr{-1};
    neospice::MatrixOffset BSIM4v7SPqPtr{-1};
...
struct BSIM4v7Model {
    int BSIM4v7modType;
    BSIM4v7Model *BSIM4v7nextModel;
    BSIM4v7Instance *BSIM4v7instances;
    const char *BSIM4v7modName;

    /* --- end of generic struct BSIM4v7Model --- */
 ...
 * move to size-dependent param */
    ...
    BSIM4v7Instance **BSIM4v7InstanceArray;
#endif
...
extern int BSIM4v7debug(BSIM4v7Model*, BSIM4v7Instance*, Shim::Ckt *, int);
extern int BSIM4v7checkModel(BSIM4v7Model*, BSIM4v7Instance*, Shim::Ckt *);
...
extern Shim::IfParm BSIM4v7pTable[];
extern int BSIM4v7pTSize;
extern Shim::IfParm BSIM4v7mPTable[];
extern int BSIM4v7mPTSize;
int BSIM4v7mParam(int param, Shim::IfValue *value, BSIM4v7Model *model);
int BSIM4v7param(int param, Shim::IfValue *value, BSIM4v7Instance *inst, Shim::IfValue *select);
