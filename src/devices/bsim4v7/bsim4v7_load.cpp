...
int
BSIM4v7load(
BSIM4v7Model *inModel,
Shim::Ckt *ckt)
{
auto &mat = *ckt->mat;
BSIM4v7Model *model = inModel;
...
line900:
       ...
       T1 = qdef * here->BSIM4v7gtau;
           if (here->BSIM4v7rgateMod == 1)
           {   mat.add(here->BSIM4v7GEgePtr, m * geltd);
               mat.add(here->BSIM4v7GPgePtr, -(m * geltd));
               mat.add(here->BSIM4v7GEgpPtr, -(m * geltd));
               mat.add(here->BSIM4v7GPgpPtr, m * (gcggb + geltd - ggtg + gIgtotg));
               mat.add(here->BSIM4v7GPdpPtr, m * (gcgdb - ggtd + gIgtotd));
               mat.add(here->BSIM4v7GPspPtr, m * (gcgsb - ggts + gIgtots));
               mat.add(here->BSIM4v7GPbpPtr, m * (gcgbb - ggtb + gIgtotb));
           } /* WDLiu: gcrg already subtracted from all gcrgg below */
           else if (here->BSIM4v7rgateMod == 2)        
           {   mat.add(here->BSIM4v7GEgePtr, m * gcrg);
               mat.add(here->BSIM4v7GEgpPtr, m * gcrgg);
               mat.add(here->BSIM4v7GEdpPtr, m * gcrgd);
               mat.add(here->BSIM4v7GEspPtr, m * gcrgs);
               mat.add(here->BSIM4v7GEbpPtr, m * gcrgb);        

               mat.add(here->BSIM4v7GPgePtr, -(m * gcrg));
               mat.add(here->BSIM4v7GPgpPtr, m * (gcggb  - gcrgg - ggtg + gIgtotg));
               mat.add(here->BSIM4v7GPdpPtr, m * (gcgdb - gcrgd - ggtd + gIgtotd));
               mat.add(here->BSIM4v7GPspPtr, m * (gcgsb - gcrgs - ggts + gIgtots));
               mat.add(here->BSIM4v7GPbpPtr, m * (gcgbb - gcrgb - ggtb + gIgtotb));
           }
           else if (here->BSIM4v7rgateMod == 3)
           {   mat.add(here->BSIM4v7GEgePtr, m * geltd);
               mat.add(here->BSIM4v7GEgmPtr, -(m * geltd));
               mat.add(here->BSIM4v7GMgePtr, -(m * geltd));
               mat.add(here->BSIM4v7GMgmPtr, m * (geltd + gcrg + gcgmgmb));

               mat.add(here->BSIM4v7GMdpPtr, m * (gcrgd + gcgmdb));
               mat.add(here->BSIM4v7GMgpPtr, m * gcrgg);
               mat.add(here->BSIM4v7GMspPtr, m * (gcrgs + gcgmsb));
               mat.add(here->BSIM4v7GMbpPtr, m * (gcrgb + gcgmbb));

               mat.add(here->BSIM4v7DPgmPtr, m * gcdgmb);
               mat.add(here->BSIM4v7GPgmPtr, -(m * gcrg));
               mat.add(here->BSIM4v7SPgmPtr, m * gcsgmb);
               mat.add(here->BSIM4v7BPgmPtr, m * gcbgmb);
           ...
           {   mat.add(here->BSIM4v7GPgpPtr, m * (gcggb - ggtg + gIgtotg));
               mat.add(here->BSIM4v7GPdpPtr, m * (gcgdb - ggtd + gIgtotd));
               mat.add(here->BSIM4v7GPspPtr, m * (gcgsb - ggts + gIgtots));
               mat.add(here->BSIM4v7GPbpPtr, m * (gcgbb - ggtb + gIgtotb));
           }
           ...
           if (model->BSIM4v7rdsMod)
           {   mat.add(here->BSIM4v7DgpPtr, m * gdtotg);
               mat.add(here->BSIM4v7DspPtr, m * gdtots);
               mat.add(here->BSIM4v7DbpPtr, m * gdtotb);
               mat.add(here->BSIM4v7SdpPtr, m * gstotd);
               mat.add(here->BSIM4v7SgpPtr, m * gstotg);
               mat.add(here->BSIM4v7SbpPtr, m * gstotb);
           }

           mat.add(here->BSIM4v7DPdpPtr, m * (gdpr + here->BSIM4v7gds + here->BSIM4v7gbd + T1 * ddxpart_dVd
                                   - gdtotd + RevSum + gcddb + gbdpdp + dxpart * ggtd - gIdtotd));
           mat.add(here->BSIM4v7DPdPtr, -(m * (gdpr + gdtot)));
           mat.add(here->BSIM4v7DPgpPtr, m * (Gm + gcdgb - gdtotg + gbdpg - gIdtotg
                                   + dxpart * ggtg + T1 * ddxpart_dVg));
           mat.add(here->BSIM4v7DPspPtr, -(m * (here->BSIM4v7gds + gdtots - dxpart * ggts + gIdtots
                                   - T1 * ddxpart_dVs + FwdSum - gcdsb - gbdpsp)));
           mat.add(here->BSIM4v7DPbpPtr, -(m * (gjbd + gdtotb - Gmbs - gcdbb - gbdpb + gIdtotb
                                   - T1 * ddxpart_dVb - dxpart * ggtb)));

           mat.add(here->BSIM4v7DdpPtr, -(m * (gdpr - gdtotd)));
           mat.add(here->BSIM4v7DdPtr, m * (gdpr + gdtot));

           mat.add(here->BSIM4v7SPdpPtr, -(m * (here->BSIM4v7gds + gstotd + RevSum - gcsdb - gbspdp
                                   - T1 * dsxpart_dVd - sxpart * ggtd + gIstotd)));
           mat.add(here->BSIM4v7SPgpPtr, m * (gcsgb - Gm - gstotg + gbspg + sxpart * ggtg
                                   + T1 * dsxpart_dVg - gIstotg));
           mat.add(here->BSIM4v7SPspPtr, m * (gspr + here->BSIM4v7gds + here->BSIM4v7gbs + T1 * dsxpart_dVs
                                   - gstots + FwdSum + gcssb + gbspsp + sxpart * ggts - gIstots));
           mat.add(here->BSIM4v7SPsPtr, -(m * (gspr + gstot)));
           mat.add(here->BSIM4v7SPbpPtr, -(m * (gjbs + gstotb + Gmbs - gcsbb - gbspb - sxpart * ggtb
                                   - T1 * dsxpart_dVb + gIstotb)));

           mat.add(here->BSIM4v7SspPtr, -(m * (gspr - gstots)));
           mat.add(here->BSIM4v7SsPtr, m * (gspr + gstot));

           mat.add(here->BSIM4v7BPdpPtr, m * (gcbdb - gjbd + gbbdp - gIbtotd));
           mat.add(here->BSIM4v7BPgpPtr, m * (gcbgb - here->BSIM4v7gbgs - gIbtotg));
           mat.add(here->BSIM4v7BPspPtr, m * (gcbsb - gjbs + gbbsp - gIbtots));
           mat.add(here->BSIM4v7BPbpPtr, m * (gjbd + gjbs + gcbbb - here->BSIM4v7gbbs
                                   - gIbtotb));
           ...
           /* stamp gidl */
           mat.add(here->BSIM4v7DPdpPtr, m * ggidld);
           mat.add(here->BSIM4v7DPgpPtr, m * ggidlg);
           mat.add(here->BSIM4v7DPspPtr, -(m * (ggidlg + ggidld + ggidlb)));
           mat.add(here->BSIM4v7DPbpPtr, m * ggidlb);
           mat.add(here->BSIM4v7BPdpPtr, -(m * ggidld));
           mat.add(here->BSIM4v7BPgpPtr, -(m * ggidlg));
           mat.add(here->BSIM4v7BPspPtr, m * (ggidlg + ggidld + ggidlb));
           mat.add(here->BSIM4v7BPbpPtr, -(m * ggidlb));
            /* stamp gisl */
           mat.add(here->BSIM4v7SPdpPtr, -(m * (ggisls + ggislg + ggislb)));
           mat.add(here->BSIM4v7SPgpPtr, m * ggislg);
           mat.add(here->BSIM4v7SPspPtr, m * ggisls);
           mat.add(here->BSIM4v7SPbpPtr, m * ggislb);
           mat.add(here->BSIM4v7BPdpPtr, m * (ggislg + ggisls + ggislb));
           mat.add(here->BSIM4v7BPgpPtr, -(m * ggislg));
           mat.add(here->BSIM4v7BPspPtr, -(m * ggisls));
           mat.add(here->BSIM4v7BPbpPtr, -(m * ggislb));


           if (here->BSIM4v7rbodyMod)
           {   mat.add(here->BSIM4v7DPdbPtr, m * (gcdbdb - here->BSIM4v7gbd));
               mat.add(here->BSIM4v7SPsbPtr, -(m * (here->BSIM4v7gbs - gcsbsb)));

               mat.add(here->BSIM4v7DBdpPtr, m * (gcdbdb - here->BSIM4v7gbd));
               mat.add(here->BSIM4v7DBdbPtr, m * (here->BSIM4v7gbd - gcdbdb 
                                       + here->BSIM4v7grbpd + here->BSIM4v7grbdb));
               mat.add(here->BSIM4v7DBbpPtr, -(m * here->BSIM4v7grbpd));
               mat.add(here->BSIM4v7DBbPtr, -(m * here->BSIM4v7grbdb));

               mat.add(here->BSIM4v7BPdbPtr, -(m * here->BSIM4v7grbpd));
               mat.add(here->BSIM4v7BPbPtr, -(m * here->BSIM4v7grbpb));
               mat.add(here->BSIM4v7BPsbPtr, -(m * here->BSIM4v7grbps));
               mat.add(here->BSIM4v7BPbpPtr, m * (here->BSIM4v7grbpd + here->BSIM4v7grbps 
                                       + here->BSIM4v7grbpb));
               /* WDLiu: (gcbbb - here->BSIM4v7gbbs) already added to BPbpPtr */        

               mat.add(here->BSIM4v7SBspPtr, m * (gcsbsb - here->BSIM4v7gbs));
               mat.add(here->BSIM4v7SBbpPtr, -(m * here->BSIM4v7grbps));
               mat.add(here->BSIM4v7SBbPtr, -(m * here->BSIM4v7grbsb));
               mat.add(here->BSIM4v7SBsbPtr, m * (here->BSIM4v7gbs - gcsbsb 
                                       + here->BSIM4v7grbps + here->BSIM4v7grbsb));

               mat.add(here->BSIM4v7BdbPtr, -(m * here->BSIM4v7grbdb));
               mat.add(here->BSIM4v7BbpPtr, -(m * here->BSIM4v7grbpb));
               mat.add(here->BSIM4v7BsbPtr, -(m * here->BSIM4v7grbsb));
               mat.add(here->BSIM4v7BbPtr, m * (here->BSIM4v7grbsb + here->BSIM4v7grbdb
                                     + here->BSIM4v7grbpb));
           }

           if (here->BSIM4v7trnqsMod)
           {   mat.add(here->BSIM4v7QqPtr, m * (gqdef + here->BSIM4v7gtau));
               mat.add(here->BSIM4v7QgpPtr, m * (ggtg - gcqgb));
               mat.add(here->BSIM4v7QdpPtr, m * (ggtd - gcqdb));
               mat.add(here->BSIM4v7QspPtr, m * (ggts - gcqsb));
               mat.add(here->BSIM4v7QbpPtr, m * (ggtb - gcqbb));

               mat.add(here->BSIM4v7DPqPtr, m * dxpart * here->BSIM4v7gtau);
               mat.add(here->BSIM4v7SPqPtr, m * sxpart * here->BSIM4v7gtau);
               mat.add(here->BSIM4v7GPqPtr, -(m * here->BSIM4v7gtau));
           }
