...
static void hfeta(HFETAModel *model, HFETAInstance *here, Shim::Ckt *ckt,
...
int HFETAload(HFETAModel *inModel, Shim::Ckt *ckt)
{
auto &mat = *ckt->mat;
        ...
        for (here = model->HFETAinstances; here != NULL ;
            ...
            if( (!(ckt->CKTmode & MODEINITFIX)) | (!(ckt->CKTmode & MODEUIC))) {
                if( (icheck == 1) 
                    ...
                    ckt->CKTnoncon++;
                     ckt->CKTtroubleElt = (HFETAInstance *) here;
                }
            }
...
load:
            ...
            *(ckt->CKTrhs + here->HFETAsourcePrmPrmNode) += m * ceqgs;
            ...
            mat.add(here->HFETAdrainDrainPtr, m * (model->HFETAdrainConduct));
            mat.add(here->HFETAsourceSourcePtr, m * (model->HFETAsourceConduct));
            mat.add(here->HFETAgatePrimeGatePrimePtr, m * (ggd+ggs+ggspp+ggdpp+gmg+model->HFETAgateConduct));
            mat.add(here->HFETAdrainPrimeDrainPrimePtr, m * (gds+ggd-gmd+model->HFETAdrainConduct+model->HFETAgf));
            mat.add(here->HFETAsourcePrimeSourcePrimePtr, m * (gds+gm+ggs+model->HFETAsourceConduct+model->HFETAgi));
            mat.add(here->HFETAsourcePrmPrmSourcePrmPrmPtr, m * (model->HFETAgi+ggspp));
            mat.add(here->HFETAdrainPrmPrmDrainPrmPrmPtr, m * (model->HFETAgf+ggdpp));
            mat.add(here->HFETAdrainDrainPrimePtr, -(m * (model->HFETAdrainConduct)));
            mat.add(here->HFETAdrainPrimeDrainPtr, -(m * (model->HFETAdrainConduct)));
            mat.add(here->HFETAsourceSourcePrimePtr, -(m * (model->HFETAsourceConduct)));
            mat.add(here->HFETAsourcePrimeSourcePtr, -(m * (model->HFETAsourceConduct)));
            mat.add(here->HFETAgatePrimeDrainPrimePtr, m * (-ggd+gmd));
            mat.add(here->HFETAdrainPrimeGatePrimePtr, m * (gm-ggd-gmg));
            mat.add(here->HFETAgatePrimeSourcePrimePtr, -(m * (ggs+gmg+gmd)));
            mat.add(here->HFETAsourcePrimeGatePrimePtr, m * (-ggs-gm));
            mat.add(here->HFETAdrainPrimeSourcePrimePtr, m * (-gds-gm+gmg+gmd));
            mat.add(here->HFETAsourcePrimeDrainPrimePtr, -(m * (gds)));
            mat.add(here->HFETAsourcePrimeSourcePrmPrmPtr, -(m * (model->HFETAgi)));            
            mat.add(here->HFETAsourcePrmPrmSourcePrimePtr, -(m * (model->HFETAgi)));
            mat.add(here->HFETAgatePrimeSourcePrmPrmPtr, -(m * (ggspp)));
            mat.add(here->HFETAsourcePrmPrmGatePrimePtr, -(m * (ggspp)));
            mat.add(here->HFETAdrainPrimeDrainPrmPrmPtr, -(m * (model->HFETAgf)));
            mat.add(here->HFETAdrainPrmPrmDrainPrimePtr, -(m * (model->HFETAgf)));
            mat.add(here->HFETAgatePrimeDrainPrmPrmPtr, -(m * (ggdpp)));
            mat.add(here->HFETAdrainPrmPrmGatePrimePtr, -(m * (ggdpp)));
            mat.add(here->HFETAgateGatePtr, m * (model->HFETAgateConduct));
            mat.add(here->HFETAgateGatePrimePtr, -(m * (model->HFETAgateConduct)));
            mat.add(here->HFETAgatePrimeGatePtr, -(m * (model->HFETAgateConduct)));
