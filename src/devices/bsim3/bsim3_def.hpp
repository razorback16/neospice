...
struct BSIM3Instance {
    BSIM3Model *BSIM3modPtr;
    BSIM3Instance *BSIM3nextInstance;
    const char *BSIM3name;
    ...
    neospice::MatrixOffset BSIM3DdPtr{-1};
    neospice::MatrixOffset BSIM3GgPtr{-1};
    neospice::MatrixOffset BSIM3SsPtr{-1};
    neospice::MatrixOffset BSIM3BbPtr{-1};
    neospice::MatrixOffset BSIM3DPdpPtr{-1};
    neospice::MatrixOffset BSIM3SPspPtr{-1};
    neospice::MatrixOffset BSIM3DdpPtr{-1};
    neospice::MatrixOffset BSIM3GbPtr{-1};
    neospice::MatrixOffset BSIM3GdpPtr{-1};
    neospice::MatrixOffset BSIM3GspPtr{-1};
    neospice::MatrixOffset BSIM3SspPtr{-1};
    neospice::MatrixOffset BSIM3BdpPtr{-1};
    neospice::MatrixOffset BSIM3BspPtr{-1};
    neospice::MatrixOffset BSIM3DPspPtr{-1};
    neospice::MatrixOffset BSIM3DPdPtr{-1};
    neospice::MatrixOffset BSIM3BgPtr{-1};
    neospice::MatrixOffset BSIM3DPgPtr{-1};
    neospice::MatrixOffset BSIM3SPgPtr{-1};
    neospice::MatrixOffset BSIM3SPsPtr{-1};
    neospice::MatrixOffset BSIM3DPbPtr{-1};
    neospice::MatrixOffset BSIM3SPbPtr{-1};
    neospice::MatrixOffset BSIM3SPdpPtr{-1};

    neospice::MatrixOffset BSIM3QqPtr{-1};
    neospice::MatrixOffset BSIM3QdpPtr{-1};
    neospice::MatrixOffset BSIM3QgPtr{-1};
    neospice::MatrixOffset BSIM3QspPtr{-1};
    neospice::MatrixOffset BSIM3QbPtr{-1};
    neospice::MatrixOffset BSIM3DPqPtr{-1};
    neospice::MatrixOffset BSIM3GqPtr{-1};
    neospice::MatrixOffset BSIM3SPqPtr{-1};
    neospice::MatrixOffset BSIM3BqPtr{-1};
...
struct BSIM3Model {
    int BSIM3modType;
    BSIM3Model *BSIM3nextModel;
    BSIM3Instance *BSIM3instances;
    const char *BSIM3modName;

    /* --- end of generic struct BSIM3Model --- */
...
#ifdef USE_OMP
    int BSIM3InstCount;
    BSIM3Instance **BSIM3InstanceArray;
#endif
...
extern int BSIM3debug(BSIM3Model*, BSIM3Instance*, Shim::Ckt *, int);
extern int BSIM3checkModel(BSIM3Model*, BSIM3Instance*, Shim::Ckt *);

// --- Parameter tables and dispatchers (defined in devsup/mpar) ------
namespace Shim { struct IfParm; struct IfValue; }
extern Shim::IfParm BSIM3pTable[];
extern int BSIM3pTSize;
extern Shim::IfParm BSIM3mPTable[];
extern int BSIM3mPTSize;
int BSIM3mParam(int param, Shim::IfValue *value, BSIM3Model *model);
int BSIM3param(int param, Shim::IfValue *value, BSIM3Instance *inst, Shim::IfValue *select);
