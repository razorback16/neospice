...
namespace Shim {
    ...
    struct Ckt {
        ...
        double CKTepsmin     = 1e-28;
        double CKTsrcFact    = 1.0;
        int    CKTfixLimit   = 0;
        int    CKTmode       = 0;
        int    CKTbadMos3    = 0;
        int    CKTnumStates  = 0;
    ...
    // CKTmkCur creates a current (branch) unknown.  In neospice's node model
    // an extra MNA row is just another internal node, so this mirrors CKTmkVolt.
